            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        {{ __('Ажурирање државе iz kreiranja grada') }}
                        <a href="{{ route('cities.create') }}" class="float-right">Назад</a>   
                    </div>
                    
                    <div class="card-body">
                        <form method="POST" action="{{ route('update-country-from-city-create', $country->id) }}">
                            @csrf
                            @method('PUT')
