    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('edit-city-from-company-create',
                                                                                                [ 
                                                                                                'city' => $city->id]
                                                                                                ) }}">{{ $city->name }}</a></li>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('edit-city-from-company-create',
                                        [ 
                                        'city' => $city->id]
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('store-country-from-company-create_2', ['city'=>$city->id]) }}">
                            @csrf
