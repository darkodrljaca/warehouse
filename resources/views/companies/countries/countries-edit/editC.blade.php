    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('create-city-from-company-create') }}">Креирање grada</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('update-country-from-company-create', ['country'=>$country->id]) }}">
                            @csrf
                            @method('PUT')
